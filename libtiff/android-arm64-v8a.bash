filename_tar=tiff-3.9.2.tar.gz
...
build_dep()
{
    ...
    ndk_cxx="$ndk_toolchain/aarch64-linux-android21-clang++"
    CC=$ndk_cc CXX=$ndk_cxx ./configure --enable-static --disable-shared --host=arm-linux-gnueabi --without-x --disable-cxx --disable-zlib --disable-jpeg
    ret=$?
    cd $root_script_dir
